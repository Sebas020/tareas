...
class Task
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="crate_at", type="datetime", nullable=true)
     */
    private $crateAt;
    ...
    public function getCrateAt(): ?\DateTimeInterface
    {
        return $this->crateAt;
    }

    public function setCrateAt(?\DateTimeInterface $crateAt): self
    {
